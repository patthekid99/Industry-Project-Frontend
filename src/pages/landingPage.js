...
export default function LandingPage(formType) {
  ...
  return (
    <>
      <section className="h-auto gradient-form bg-gray-200 md:h-screen">
                ...
                <div className="lg:flex lg:flex-wrap g-0">
                    ...
                    <div className="md:p-12 md:mx-6">
                      <div className="text-center">
                        <img
                          ...
                          alt="logo"
                        />
                        <h4 className="text-3xl font-semibold">{state ? "Sign in to your account" : "Register for your free account"}</h4>
                        {state ? 
                          <form onSubmit={Login}>
                            <p className="my-4 text-center font-medium text-chairgreen-600 hover:text-chairgreen-500" onClick={() => setState(false)}>Or register for a free account</p>
                            <div className="mb-4">
                              <input
                                type="email"
                          ...
                          <p className="my-4 text-center font-medium text-chairgreen-600 hover:text-chairgreen-500" onClick={() => setState(true)}>Or if you already have an account signin</p>
                          <div className="mb-4">
                            <input
                              type="email"
                              className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                  ...
                  <div className='lg:w-6/12 flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none bg-chairgreen-500'>
                      <div className='text-white px-4 py-6 md:p-12 md:mx-6'>
                        ...
                        <h1 className='text-xl font-semibold mb-6'>For People, Property and Prosperity</h1>
