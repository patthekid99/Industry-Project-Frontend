            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
              <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <p className="my-2 text-center font-medium text-chairgreen-600 hover:text-chairgreen-500">
                    <Link to={"/register"}>Or register for a free account</Link> 
                </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <input
                        ...
                        name="remember-me"
                        type="checkbox"
                        className="h-4 w-4 text-chairgreen-600 focus:ring-chairgreen-500 border-gray-300 rounded"
                      />
                    ...
                    <div className="text-sm">
                      <a href="#" className="font-medium text-chairgreen-600 hover:text-chairgreen-500">
